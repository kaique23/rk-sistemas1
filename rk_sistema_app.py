...
class App(CTk):
    ...
    def _carregar_logo(self):
        ...
        if os.path.exists(logo_path):
            try:
                ...
                self.logo_bg = CTkImage(light_image=img, dark_image=img, size=(520, 260))
            except Exception:
                self.logo_top = None
                self.logo_login = None
                self.logo_bg = None
    ...
    def _marca_dagua(self, parent):
        if self.logo_bg:
            ...
            lbl.place(relx=0.68, rely=0.55, anchor="center")
    ...
    def admin_empresas_screen(self):
        ...
        for emp in empresas:
            ...
            self._botao(
                card,
                "Ver módulos",
                lambda eid=emp["id"]: self.admin_modulos_popup(eid),
                color=COR_PRIMARIA,
                hover=COR_PRIMARIA_HOVER,
                width=130
    ...
    def colaboradores_screen(self):
        ...
        for col in data:
            ...
            self._botao(
                card,
                "Editar permissões",
                lambda c=col: self.editar_permissoes_popup(c),
                color=COR_PRIMARIA,
                hover=COR_PRIMARIA_HOVER,
                width=150
            ).pack(anchor="e", padx=10, pady=(0, 10))
